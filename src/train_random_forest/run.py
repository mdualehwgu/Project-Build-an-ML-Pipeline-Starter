...
def go(args):
    ...
    # Log r2 and MAE to W&B summary
    run.summary['r2'] = r_squared
    run.summary['mae'] = mae

    # Upload the feature importance visualization
    run.log(
        {
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    # Impute numerical columns with 0 for missing values
    zero_imputed = [
        "minimum_nights",
        "number_of_reviews",
        "reviews_per_month",
    ...
    # Put everything together in a ColumnTransformer
